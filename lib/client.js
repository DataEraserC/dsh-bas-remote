...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function apply(ctx) {
      ...
      // Inject missing @keyframes for the Spinner animation
      var styleEl = document.createElement('style')
      styleEl.textContent = '@keyframes dsh-bas-spin { to { transform: rotate(360deg); } }'
      document.head.appendChild(styleEl)
      ctx.effect(function () { document.head.removeChild(styleEl) }, NS + '.spin-keyframes')
