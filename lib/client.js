  ...
  factory: (require) => {
    ...
    function DevSpaceRow(props) {
      ...
      if (tunnel) {
        ...
        controls.push(React.createElement('span', { key: 'endpoint', style: { color: T.textMuted, fontSize: 12 } }, '127.0.0.1:' + tunnel.localPort))
    ...
    function BasStatusPill() {
      ...
      return React.createElement('div', {
        ...
        style: {
          ...
          // plain child, so a block-level pill would stretch into a band: anchor
          // it as a compact floating chip instead.
          position: 'absolute', bottom: 12, right: 12, zIndex: 40, width: 'max-content',
