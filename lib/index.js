...
export function apply(ctx, config) {
  ...
  function remoteWorkspaceLines(entry) {
    ...
    return [
      ...
      'mirror/pick → "not a directory (or unreachable)") cannot work here. Move files over exec instead:',
